...
description: >
  ...
  everything, the sun-bleached cream canvas, the nine-color candy palette, Manrope + Space
...
typography:
  # — reading ramp (Manrope) —
  body:      { fontFamily: "Manrope", cqw: 0.85, weight: 400, lineHeight: 1.6 }
  subtitle:  { fontFamily: "Manrope", cqw: 0.95, weight: 400, tracking: "0.18em", upper: true }
  pill-text: { fontFamily: "Manrope", cqw: 0.75, weight: 600, tracking: "0.12em", upper: true }
  label:     { fontFamily: "Manrope", px: 14, weight: 500, tracking: "0.1em", upper: true }
  # — display / hero ramp (Manrope, ink, sentence case) —
  card-headline:{ fontFamily: "Manrope", cqw: 1.9, weight: 700, lineHeight: 1.1 }
  orbit-numeral:{ fontFamily: "Manrope", cqw: 2.6, weight: 700, lineHeight: 1.0 }
  quote-display:{ fontFamily: "Manrope", cqw: 4.2, weight: 600, lineHeight: 1.3, tracking: "-0.01em" }
  stat-number: { fontFamily: "Manrope", cqw: 3.6, weight: 800, lineHeight: 1.0, tracking: "-0.03em" }
  section-headline:{ fontFamily: "Manrope", cqw: 4.0, weight: 700, lineHeight: 1.05, tracking: "-0.01em" }
  headline:    { fontFamily: "Manrope", cqw: 5.0, weight: 700, lineHeight: 1.05, tracking: "-0.02em" }
  closing-display:{ fontFamily: "Manrope", cqw: 8.5, weight: 800, lineHeight: 0.95, tracking: "-0.03em" }
  display:     { fontFamily: "Manrope", cqw: 12.0, weight: 800, lineHeight: 0.88, tracking: "-0.03em" }
...
components:
  ...
  pill-card:
    ...
    description: "Holds a circular card-icon, Bodoni headline, Manrope body."
  stat-pill:
    backgroundColor: "{colors.white}"
    border: "0.2cqw solid {colors.outline}"
    rounded: "2rem"
...
- **Fonts** — already set to **Manrope** (display) / **Manrope** (body); ignore any preset font name lingering in prose.
- **Weights** — the brand font ships `{400, 500, 600, 650, 700, 750, 800}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
...
The voice is a two-face conversation: **Manrope** (didone serif, weight 700–800, always ink,
always sentence case) carries every headline, stat, and quote; **Manrope** carries body and
...
- **Manrope** display (ink, sentence case) + **Manrope** body/pills (uppercase, tracked).
...
Two ramps. The **reading ramp** (Manrope body 0.85cqw, uppercase tracked pill/label text)
...
- **Bodoni 700+ in ink, sentence case** (italic via `<em>` only, color allowed on the italic key word as a candy hue); **Manrope pills/labels uppercase, 0.08em+ tracked**; negative-track Bodoni display.
...
- **Manrope + Manrope via Google Fonts.** CJK pairing (ZCOOL XiaoWei / Yozai) carries over from the source.
...
## Yuvo user direction — overrides decorative preset examples

Use flat color circles, warm paper and clean Manrope. No grain, noise, texture, gradients, confetti, daisies or invented icons. User asked for minimal illustration detail. Do not outline decorative circles. Do not wrap everything in pills. Real app captures dominate demo shots, with limited purposeful motion. No fake research data or recreated UI. Minimum video labels 28px, supporting copy 34px. Keep critical copy inside x=100..1820,y=90..950; no captions over the working app. Use real supplied logos only.
