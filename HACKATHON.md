...
- Motion revision: `videos/yuvo-hackathon/renders/yuvo-hackathon-motion.mp4` (Cirrus review) and `yuvo-hackathon-motion-ccby.mp4` in the same directory (Funkorama, CC BY). Both exports are 131.734 seconds, 1920×1080, 30 fps, H.264/AAC. Actual rendered frames inspected, including the corrected macOS arrow at 70.2, 70.8 and 72 seconds. Camera moves, animated graphics and 24 sound-effect cues accompany seven scenes and three Google TTS voices. Review mix: −13.28 LUFS / −1.14 dBTP; CC BY mix: −16.28 LUFS / −4.16 dBTP. Composition checks report zero errors or warnings; all six motion seams pass. Cirrus publication rights remain unverified; its source stays outside Git. English SRT and music attribution accompany the source. The original landing video remains a scripted preview.
