...
export const DEMO_REVISION = "An episodic cozy mystery about a young woman who speaks to abandoned buildings. Each building remembers only through sound in pipes, heat in brick, and pressure in floors. She must solve a case before the building is demolished; the audience learns the five rules of building-memory before the first clue.";

export const DEMO_AUDIENCE = {
  consensus: "The revision gives the central power clear limits and a deadline. The next draft should show those limits in action before asking the audience to solve the mystery.",
  perspectives: [
    { role: "Genre Fan", verdict: "Now I can try to solve along.", critique: "The five rules promise a fair puzzle. Keep those rules consistent when the reveal arrives.", comparison: "Incomplete memories become a defined clue system instead of an open-ended power.", nextMove: "Show one rule producing a misleading clue and another correcting it." },
    { role: "Casual Viewer", verdict: "The demolition gives me a reason to care.", critique: "A deadline makes the premise easier to follow, but the building still needs an emotional connection to a person.", comparison: "The original hook gains a visible consequence if the investigation fails.", nextMove: "Introduce a resident whose history disappears with the building." },
    { role: "Story Nerd", verdict: "The constraint finally drives the story.", critique: "Material traces can make the mystery visual. Avoid explaining all five rules in a single speech.", comparison: "The supernatural mechanic now shapes both evidence and pacing.", nextMove: "Reveal each rule through a consequential action in the opening sequence." },
  ],
};
